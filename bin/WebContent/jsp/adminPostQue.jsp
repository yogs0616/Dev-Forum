...
<title>Admin :: Ask Question</title>
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-lg-8 col-md-8">
						<!-- POST -->
						<div class="post">
							<form:form action="postQue" class="form newtopic" method="post"
								...
								<div class="topwrap">
									...
									<div class="posttext pull-left">
										...
										<div>
											<form:textarea path="queryDesc" id="desc"
					...
					<div class="col-lg-4 col-md-4">
						...
						<div class="sidebarblock">
							...
							<div class="blocktxt">
								<ul class="cats">
									<li><a href="adminPostQue">Ask a Question?<span
											class="badge pull-right"></span></a></li>
