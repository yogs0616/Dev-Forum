			...
			<div class="container">
				<div class="row">
					<div class="col-lg-8 col-md-8">
							...
							<div class="post beforepagination">
								...
								<div class="postinfobot">
									...
									<div class="likeblock pull-left">
										<a href="increaseLike?queryId=${que.queryId}" class="up"><i
											class="fa fa-thumbs-o-up"></i>Likes ${que.no_of_likes}</a>
						...
						<c:forEach var="ans" items="${answerList}">
							<div class="post">
								...
								<div class="postinfobot">
									...
									<div class="next pull-right">
										<a
											href="deleteAns?solutionId=${ans.solutionId}&queryId=${ans.queryId}">Delete</a>
						...
						<div class="post">
							<<<<<<< .mine
							<form:form action="adminWelcome2" class="form" method="post"
								modelAttribute="answerBean">
=======
							<form:form action="viewAns" class="form" method="post"
									modelAttribute="answerBean">
>>>>>>> .r451
								<div class="topwrap">
